...
private:
    ...
    */
    ...
    void setupDebugMessenger() {
        if constexpr (not ENABLE_VALIDATION) {
            return;
        }
    ...
    void createInstance() {
        ...
        // GLFW extensions (platform specific for windowing)
        ...
        if (ENABLE_VALIDATION) {
            ...
            // Setting a seperate debug callback for vkCreateInstance and vkDestroyInstance
